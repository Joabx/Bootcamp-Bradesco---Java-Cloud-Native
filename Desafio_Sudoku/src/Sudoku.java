...
public class Sudoku {
        ...
        for (int i = 0; i < BOARD_LIMIT; i++) {
            ...
            for (int j = 0; j < BOARD_LIMIT; j++) {
                ...
                if (positionConfig == null) {
                    // Caso não tenha valor informado, preenche com espaço vazio fixo falso
                    spaces.get(i).add(new Space(0, false));
                    continue;
                }
                var split = positionConfig.split(",");
                var expected = Integer.parseInt(split[0]);
                var fixed = Boolean.parseBoolean(split[1]);
    ...
    private static void inputNumber() {
        ...
        System.out.println("Informe a linha que o número será inserido (0-8)");
        var row = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a coluna que o número será inserido (0-8)");
    ...
    private static void removeNumber() {
        ...
        System.out.println("Informe a linha que o número será removido (0-8)");
        var row = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a coluna que o número será removido (0-8)");
        var col = runUntilGetValidNumber(0, 8);
