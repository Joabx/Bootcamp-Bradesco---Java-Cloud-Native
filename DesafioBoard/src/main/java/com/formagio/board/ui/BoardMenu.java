...
import com.formagio.board.service.BoardColumnQueryService;
import com.formagio.board.service.BoardQueryService;
import com.formagio.board.service.CardQueryService;
import com.formagio.board.service.CardService;
...
public class BoardMenu {
    ...
    public BoardMenu(BoardEntity board, Connection conn) {
        this.entity = board;
        this.conn = conn;
    }
    ...
    private void createCard() throws SQLException {
        ...
        card.setTitle(scannerString.next());
        System.out.println("Informe a descrição do card");
        card.setDescription(scannerString.next());
    ...
    private void showBoard() throws SQLException {
        ...
        var optional = new BoardQueryService(conn).showBoardDetails(id);
        ...
        new CardQueryService(conn).findById(selectedCardId)
                .ifPresentOrElse(
                        c -> {
                            ...
                            System.out.println(
                                    c.blocked() ? "Está bloqueado. Motivo: " + c.blockReason() : "Não está bloqueado");
